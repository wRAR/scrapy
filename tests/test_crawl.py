...
class TestCrawl:
    ...
    async def test_delay(
        self, total: int, delay: float, randomize: bool, mockserver: MockServer
    ) -> None:
        crawl_kwargs = {
            "maxlatency": delay * 2,
    ...
    def test_timeout_success(
        ...
        yield crawler.crawl(n=0.5, mockserver=mockserver)
    ...
    def test_timeout_failure(
        ...
        crawler = get_crawler(DelaySpider, {"DOWNLOAD_TIMEOUT": 0.35})
        yield crawler.crawl(n=0.5, b=1, mockserver=mockserver)
        assert isinstance(crawler.spider, DelaySpider)
        assert crawler.spider.t1 > 0
        assert crawler.spider.t2 == 0
        assert crawler.spider.t2_err > 0
    ...
    def test_retry_503(
        ...
        with LogCapture() as log:
            yield crawler.crawl(mockserver.url("/status?n=503"), mockserver=mockserver)
        self._assert_retried(log)

    @inline_callbacks_test
    def test_retry_conn_failed(
        self, mockserver: MockServer
    ) -> Generator[Deferred[Any], Any, None]:
        crawler = get_crawler(SimpleSpider)
        with LogCapture() as log:
    ...
    @inline_callbacks_test
    def test_start_bug_before_yield(
        self, mockserver: MockServer
    ) -> Generator[Deferred[Any], Any, None]:
        with LogCapture("scrapy", level=logging.ERROR) as log:
            crawler = get_crawler(BrokenStartSpider)
            yield crawler.crawl(fail_before_yield=1, mockserver=mockserver)
    ...
    @inline_callbacks_test
    def test_start_bug_yielding(
        self, mockserver: MockServer
    ) -> Generator[Deferred[Any], Any, None]:
        with LogCapture("scrapy", level=logging.ERROR) as log:
            crawler = get_crawler(BrokenStartSpider)
            yield crawler.crawl(fail_yielding=1, mockserver=mockserver)
    ...
    @inline_callbacks_test
    def test_start_unsupported_output(
        self, mockserver: MockServer
    ) -> Generator[Deferred[Any], Any, None]:
...
"""
        ...
        crawler = get_crawler(SimpleSpider)
        with LogCapture() as log:
            yield crawler.crawl(mockserver.url(f"/raw?{query}"), mockserver=mockserver)
        assert str(log).count("Got response 200") == 1

    @inline_callbacks_test
    def test_retry_conn_lost(
        self, mockserver: MockServer
    ) -> Generator[Deferred[Any], Any, None]:
        # connection lost after receiving data
        crawler = get_crawler(SimpleSpider)
        with LogCapture() as log:
            yield crawler.crawl(mockserver.url("/drop?abort=0"), mockserver=mockserver)
        self._assert_retried(log)

    @inline_callbacks_test
    def test_retry_conn_aborted(
        self, mockserver: MockServer
    ) -> Generator[Deferred[Any], Any, None]:
        # connection lost before receiving data
        crawler = get_crawler(SimpleSpider)
        with LogCapture() as log:
            yield crawler.crawl(mockserver.url("/drop?abort=1"), mockserver=mockserver)
        self._assert_retried(log)
    ...
    def test_referer_header(
        ...
        yield crawler.crawl(seed=req0, mockserver=mockserver)
    ...
    def test_open_spider_error_on_faulty_pipeline(
        ...
        with pytest.raises(ZeroDivisionError):
            yield crawler.crawl(mockserver.url("/status?n=200"), mockserver=mockserver)
        assert not crawler.crawling

    @inline_callbacks_test
    def test_crawlerrunner_accepts_crawler(
        self, mockserver: MockServer
    ) -> Generator[Deferred[Any], Any, None]:
        crawler = get_crawler(SimpleSpider)
...
class TestCrawlSpider:
    ...
    @inline_callbacks_test
    def test_crawlspider_with_parse(
        self, mockserver: MockServer
    ) -> Generator[Deferred[Any], Any, None]:
    ...
    @inline_callbacks_test
    def test_crawlspider_with_async_callback(
        self, mockserver: MockServer
    ) -> Generator[Deferred[Any], Any, None]:
    ...
    @inline_callbacks_test
    def test_crawlspider_with_async_generator_callback(
        self, mockserver: MockServer
    ) -> Generator[Deferred[Any], Any, None]:
    ...
    @inline_callbacks_test
    def test_crawlspider_with_errback(
        self, mockserver: MockServer
    ) -> Generator[Deferred[Any], Any, None]:
    ...
    @inline_callbacks_test
    def test_crawlspider_process_request_cb_kwargs(
        self, mockserver: MockServer
    ) -> Generator[Deferred[Any], Any, None]:
    ...
    async def test_async_def_asyncio_parse_items_list(
        ...
        log, items, _ = await self._run_spider(AsyncDefAsyncioReturnSpider, mockserver)
        assert "Got response 200" in str(log)
    ...
    @pytest.mark.only_asyncio
    @coroutine_test
    async def test_async_def_asyncgen_parse(self, mockserver: MockServer) -> None:
        log, _, stats = await self._run_spider(AsyncDefAsyncioGenSpider, mockserver)
        assert "Got response 200" in str(log)
    ...
    @pytest.mark.only_asyncio
    @coroutine_test
    async def test_async_def_asyncgen_parse_loop(self, mockserver: MockServer) -> None:
        log, items, stats = await self._run_spider(
    ...
    @pytest.mark.only_asyncio
    @coroutine_test
    async def test_async_def_asyncgen_parse_exc(self, mockserver: MockServer) -> None:
        log, items, stats = await self._run_spider(
    ...
    async def test_async_def_asyncgen_parse_complex(
        ...
        _, items, stats = await self._run_spider(
    ...
    async def test_async_def_asyncio_parse_reqs_list(
        ...
        log, *_ = await self._run_spider(AsyncDefAsyncioReqsReturnSpider, mockserver)
    ...
    async def test_async_def_deferred_direct(self, mockserver: MockServer) -> None:
        _, items, _ = await self._run_spider(AsyncDefDeferredDirectSpider, mockserver)
        assert items == [{"code": 200}]

    @pytest.mark.only_asyncio
    @coroutine_test
    async def test_async_def_deferred_wrapped(self, mockserver: MockServer) -> None:
        _, items, _ = await self._run_spider(AsyncDefDeferredWrappedSpider, mockserver)
        assert items == [{"code": 200}]
    ...
    async def test_async_def_deferred_maybe_wrapped(
        ...
        _, items, _ = await self._run_spider(
            AsyncDefDeferredMaybeWrappedSpider, mockserver
        )
        assert items == [{"code": 200}]

    @inline_callbacks_test
    def test_response_ssl_certificate_none(
        self, mockserver: MockServer
    ) -> Generator[Deferred[Any], Any, None]:
        crawler = get_crawler(SingleRequestSpider)
        url = mockserver.url("/echo?body=test", is_secure=False)
        yield crawler.crawl(seed=url, mockserver=mockserver)
        assert isinstance(crawler.spider, MetaSpider)
    ...
    @inline_callbacks_test
    def test_bytes_received_stop_download_callback(
        self, mockserver: MockServer
    ) -> Generator[Deferred[Any], Any, None]:
    ...
    @inline_callbacks_test
    def test_bytes_received_stop_download_errback(
        self, mockserver: MockServer
    ) -> Generator[Deferred[Any], Any, None]:
        ...
        assert isinstance(crawler.spider.meta["failure"].value.response, Response)  # type: ignore[attr-defined]
        assert crawler.spider.meta[  # type: ignore[attr-defined]
            "failure"
        ].value.response.body == crawler.spider.meta.get("bytes_received")
        assert (
            len(crawler.spider.meta["failure"].value.response.body)  # type: ignore[attr-defined]
            < crawler.spider.full_response_length
        )

    @inline_callbacks_test
    def test_headers_received_stop_download_callback(
        self, mockserver: MockServer
    ) -> Generator[Deferred[Any], Any, None]:
    ...
    @inline_callbacks_test
    def test_headers_received_stop_download_errback(
        self, mockserver: MockServer
    ) -> Generator[Deferred[Any], Any, None]:
    ...
    @inline_callbacks_test
    def test_spider_callback_deferred_deprecated(
        self, mockserver: MockServer
    ) -> Generator[Deferred[Any], Any, None]:
    ...
    @inline_callbacks_test
    def test_spider_errback_exception(
        self, mockserver: MockServer
    ) -> Generator[Deferred[Any], Any, None]:
        def eb(failure: Failure) -> None:
    ...
    @inline_callbacks_test
    def test_spider_errback_request(
        self, mockserver: MockServer
    ) -> Generator[Deferred[Any], Any, None]:
    ...
    @inline_callbacks_test
    def test_spider_errback_downloader_error(
        self, mockserver: MockServer
    ) -> Generator[Deferred[Any], Any, None]:
        failures = []
        ...
        crawler = get_crawler(SingleRequestSpider)
        with LogCapture() as log:
            yield crawler.crawl(seed=mockserver.url("/drop?abort=1"), errback_func=eb)
        assert len(failures) == 1
        assert "Error downloading" in str(log)
        assert "Spider error processing" not in str(log)

    @inline_callbacks_test
    def test_spider_errback_downloader_error_exception(
        self, mockserver: MockServer
    ) -> Generator[Deferred[Any], Any, None]:
        def eb(failure: Failure) -> None:
            raise ValueError("foo")
    ...
    @inline_callbacks_test
    def test_spider_errback_downloader_error_item(
        self, mockserver: MockServer
    ) -> Generator[Deferred[Any], Any, None]:
        def eb(failure: Failure) -> Any:
            return {"foo": "bar"}
    ...
    @inline_callbacks_test
    def test_spider_errback_downloader_error_request(
        self, mockserver: MockServer
    ) -> Generator[Deferred[Any], Any, None]:
        def eb(failure: Failure) -> Request:
            return Request(mockserver.url("/"))
    ...
    @inline_callbacks_test
    def test_spider_errback_deferred_deprecated(
        self, mockserver: MockServer
    ) -> Generator[Deferred[Any], Any, None]:
        def eb(failure: Failure) -> Any:
            return succeed(None)
    ...
    @inline_callbacks_test
    def test_raise_closespider_reason(
        self, mockserver: MockServer
    ) -> Generator[Deferred[Any], Any, None]:
        def cb(response):
